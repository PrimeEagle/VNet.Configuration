...
namespace VNet.Configuration.Attributes.Validation
{
    ...
    {
        private const double StartLimit = 0d;
        private const double EndLimit = 100d;
        ...
        protected override ValidationResult IsValid(object? value, ValidationContext validationContext)
        {
            ...
            return startVal < StartLimit || endVal > EndLimit ? new ValidationResult(ErrorMessage) : ValidationResult.Success;
        }
    }
}