...
namespace VNet.Configuration.Attributes.Validation
{
    ...
    public class ValueIfTrueAttribute : ValidationAttribute
    {
        private readonly string _dependentPropertyName;
        private readonly object? _value;

        public ValueIfTrueAttribute(object? value, string dependentPropertyName)
        {
        ...
        protected override ValidationResult IsValid(object? value, ValidationContext validationContext)
        {
            ...
            {
                throw new InvalidOperationException($"{nameof(ValueIfTrueAttribute)} can only be applied to boolean properties.");
            }
