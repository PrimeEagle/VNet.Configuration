...
namespace VNet.Configuration.Attributes.Validation
{
    ...
    public class TrueIfTrueAttribute : ValidationAttribute
    {
        ...
        protected override ValidationResult IsValid(object? value, ValidationContext validationContext)
        {
            ...
            {
                throw new InvalidOperationException($"{nameof(TrueIfTrueAttribute)} can only be applied to boolean properties.");
            }
            ...
            {
                return new ValidationResult($"{nameof(TrueIfTrueAttribute)} can only be used with a boolean dependent property.");
            }
