...
namespace VNet.Configuration.Attributes.Validation
{
    ...
    public class FalseIfTrueAttribute : ValidationAttribute
    {
        ...
        public FalseIfTrueAttribute(string dependentPropertyName)
        {
        ...
        protected override ValidationResult IsValid(object? value, ValidationContext validationContext)
        {
            ...
            {
                throw new InvalidOperationException($"{nameof(FalseIfTrueAttribute)} can only be applied to boolean properties.");
            }
            ...
            {
                return new ValidationResult($"{nameof(FalseIfTrueAttribute)} can only be used with a boolean dependent property.");
            }
